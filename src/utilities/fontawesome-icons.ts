...
import { 
    ...
    faHeart, faCodeBranch, faShuffle, faRotateLeft, faVial, faRobot } 
    from "@fortawesome/free-solid-svg-icons";
import { faJs, faVuejs, faDiscord, faThreads } 
    from "@fortawesome/free-brands-svg-icons";
import { faCircleDown, faEye, faEyeSlash, faFloppyDisk, faTrashCan, faImage, faCopy, faCircle, faSquarePlus, faRectangleXmark,
    faSquareCaretLeft
} 
...
library.add(faPhone, faUser, faFlag, faJs, faVuejs, faDiscord, faMagnifyingGlass, faCircleDown, 
    ...
    faShuffle, faRectangleXmark, faSquareCaretLeft, faRotateLeft, faVial, faEyeSlash, faRobot
);
