        ...
        <div class="col-lg-6">
          <div class="hero-content">
            ...
            <div class="hero-btns text-center">
              <router-link to="/collection" class="main-btn btn-hover wow fadeInUp" href="#" data-wow-delay=".6s">Ma Collection</router-link>
              <router-link to="/deckbuilder" class="main-btn border-btn btn-hover wow fadeInUp" href="#"
                data-wow-delay=".6s">Deckbuilder</router-link>
            </div>
          </div>
        </div>
        <div class="col-lg-6">
  ...
  <footer id="footer" class="footer">
    ...
    <div class="container">
      ...
      <div class="copy-right-wrapper">
        <p>Designed and Developed by <a href="https://www.instagram.com/auwelord/" rel="nofollow" target="_blank">Auwelord</a></p>
      </div>
    </div>
